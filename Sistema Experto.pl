...
new(Label1,label(text,'..........................UNIVERSIDAD DE LA UMSA.......................')),% muestra texto dentro de los label
...
principal:-
	new(D2, dialog('SISTEMA EXPERTO UMSA',size(500,400))), %inicio de nuestra interfaz emergente
...
main1:-
	new(D3, dialog('SISTEMA EXPERTO UMSA',size(500,400))),
...
main2:-
new(D4, dialog('SISTEMA EXPERTO UMSA',size(500,400))),
